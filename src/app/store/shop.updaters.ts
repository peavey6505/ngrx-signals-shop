...
//PartialStateUpdater - take previous state of type and return partial state of same type - Only properties that changes
...
export function checkoutCart(): PartialStateUpdater<ShopSlice> {
  return (_) => ({ cartQuantities: {}, cartVisible: false });
}
